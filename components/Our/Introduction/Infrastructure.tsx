...
import infrasImageTableVN from "../../../assets/image/our/introduction/infras-image-table-vn.png"
import infrasImageTableEN from "../../../assets/image/our/introduction/infras-image-table-en.png"
                ...
                <div className="space-y-2">
                    ...
                    <div>
                        ...
                        <ul className="list-disc pl-5">
                            ...
                            <li>{t("Infrastructure8")}</li>
                            <li>{t("Infrastructure9")}</li>
                        </ul>
                    </div>
                    <br/>
                    <p>{t("Infrastructure10")}</p>
                    <Image src={locale === "en" ? infrasImageTableEN : infrasImageTableVN} alt="infrasImageTable"/>
                    <br/>
                    <div>
                        <p>
                            <span
                                className="italic">{t("Infrastructure11").split(":")[0]}:</span> {t("Infrastructure11").split(":")[1]}
                        </p>
                        <p>{t("Infrastructure12")}</p>
                        <br/>
                        <p>{t("Infrastructure13")}</p>
                        <p>{t("Infrastructure14")}</p>
                    </div>
                </div>
            </div>
            <div className="py-5">
